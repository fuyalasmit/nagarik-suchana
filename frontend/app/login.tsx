...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    if (!email.trim() || !password.trim()) {
      setMessage(t("auth.enterEmailPassword"));
      setIsError(true);
      return;
    }
    ...
    if (
      ...
      setMessage(t("auth.adminLoginSuccess"));
      setIsError(false);
      setTimeout(() => {
    ...
    try {
      ...
      setMessage(err.message || t("auth.loginFailed"));
      setIsError(true);
    } finally {
      setIsLoading(false);
    }
        ...
        >
          <VStack space="xl">
            <Box>
              <Heading
                size="2xl"
                style={{ color: "#1F2937", fontWeight: "700", marginBottom: 4 }}
              >
                {t("auth.signIn")}
              </Heading>
            ...
            <FormControl isRequired>
              ...
              >
                ...
                <TouchableOpacity>
                  <Text
                    size="sm"
                    style={{ color: Palette.accentStrong, fontWeight: "600" }}
                  >
              ...
              <HStack space="xs" style={{ justifyContent: "center" }}>
                ...
                <TouchableOpacity>
                  <ExpoLink href="/register">
                    <Text
                      size="md"
                      style={{ color: Palette.accentStrong, fontWeight: "700" }}
                    >
