...
const mockGrievances = [
    {
        ...
        description:
            "The street light near my house has been broken for 2 weeks. It creates safety issues during night time.",
    ...
    },
    {
        ...
        description:
            "Garbage has not been collected from our area for the past week. The smell is becoming unbearable.",
        category: "sanitation",
        priority: "high",
        status: "pending",
...
export default function GrievancesScreen() {
    ...
    const handleSubmitGrievance = async () => {
        if (!newGrievance.title || !newGrievance.description || !newGrievance.category) {
            Alert.alert(t("common.error"), t("grievances.fillRequired"));
            return;
        }

        try {
            const response = await fetch(API_CONFIG.user.grievances, {
                method: "POST",
                headers: {
            ...
            Alert.alert(t("common.success"), t("grievances.submitSuccess"));
            setShowModal(false);
            setNewGrievance({
                title: "",
                description: "",
            ...
            Alert.alert(t("common.error"), error instanceof Error ? error.message : "Failed to submit grievance");
        }
    };
        ...
        <>
            <ScrollView
                ...
                <VStack style={{ marginBottom: 24 }}>
                    <HStack style={{ justifyContent: "space-between", alignItems: "center" }}>
                        <VStack>
                            ...
                            <Text style={{ fontSize: 14, color: "#6B7280" }}>{t("grievances.trackManage")}</Text>
                        </VStack>
                ...
                <Box style={{ marginBottom: 24 }}>
                    <Input
                        ...
                        <InputField
                            placeholder={t("grievances.search")}
                            value={searchQuery}
                ...
                <HStack style={{ marginBottom: 24 }} space="md">
                    <Box
                        ...
                        <Text style={{ fontSize: 12, color: "#6B7280" }}>{t("grievances.pending")}</Text>
                    </Box>
                    <Box
                        style={{
                            flex: 1,
                        ...
                        <Text style={{ fontSize: 12, color: "#6B7280" }}>{t("grievances.inProgress")}</Text>
                    </Box>
                    <Box
                        style={{
                            flex: 1,
                        ...
                        <Text style={{ fontSize: 12, color: "#6B7280" }}>{t("grievances.resolved")}</Text>
                    </Box>
                </HStack>
                                ...
                                <VStack space="sm">
                                    ...
                                    {grievance.response && (
                                        <Box
                                            ...
                                            <Text style={{ fontSize: 12, color: "#1E40AF" }}>{grievance.response}</Text>
                                        </Box>
                                    )}
                ...
                {filteredGrievances.length === 0 && (
                    <Box style={{ alignItems: "center", marginTop: 40 }}>
                        <Text style={{ fontSize: 16, color: "#6B7280", textAlign: "center" }}>No grievances found</Text>
                        <Text
                            style={{
                                fontSize: 14,
                                color: "#9CA3AF",
            ...
            <Modal isOpen={showModal} onClose={() => setShowModal(false)}>
                ...
                <ModalContent style={{ maxWidth: "90%", width: 400 }}>
                    <ModalHeader>
                        <Heading size="lg" style={{ color: "#1F2937" }}>
                            Submit Grievance
                        </Heading>
                        <ModalCloseButton />
                    </ModalHeader>
                    ...
                    <ModalFooter>
                        <HStack space="md" style={{ width: "100%" }}>
                            <Button variant="outline" onPress={() => setShowModal(false)} style={{ flex: 1 }}>
