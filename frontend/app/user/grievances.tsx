...
const mockGrievances = [
  {
    ...
    response:
      "Maintenance team has been notified. Work will be completed within 3 days.",
  },
  {
    id: "g2",
  ...
  },
  {
    ...
    description:
      "No water supply for the past 3 days in our locality. Need immediate attention.",
    category: "utilities",
    priority: "high",
    status: "resolved",
      ...
      const response = await fetch("http://localhost:3001/api/grievances", {
        ...
        body: JSON.stringify({
          ...
          wardNumber: newGrievance.wardNumber
            ? parseInt(newGrievance.wardNumber)
            : undefined,
        }),
      });
              ...
              <FormControl>
                ...
                <Input variant="outline">
                  <InputField
                    ...
                    onChangeText={(text) =>
                      setNewGrievance({ ...newGrievance, location: text })
                    }
                  />
                </Input>
              </FormControl>
