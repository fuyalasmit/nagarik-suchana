...
const mockNotices = [
  {
    ...
    description: 'Bharatpur Metropolitan City is seeking qualified candidates for Health Assistant positions.',
  ...
  },
  {
    ...
    description: 'Scheduled road maintenance work will be conducted on Main Road from January 10-15.',
  ...
  },
  {
    ...
    description: 'Water supply will be temporarily disrupted for maintenance work.',
    ...
    >
      ...
      <VStack style={{ marginBottom: 24 }}>
        ...
        <Text style={{ fontSize: 14, color: '#6B7280', marginTop: 2 }}>
          Stay updated with community notices
        </Text>
      </VStack>
            ...
            >
              <VStack space="xs">
                <HStack style={{ justifyContent: 'space-between', alignItems: 'flex-start' }}>
                  ...
                  <Box
                    style={{
                      backgroundColor: notice.isRelevant ? '#DCFCE7' : '#F3F4F6',
                      paddingHorizontal: 8,
                      paddingVertical: 4,
                      borderRadius: 6,
                      marginLeft: 8,
                  ...
                  >
                    <Text style={{ 
                      ...
                      {notice.isRelevant ? 'Relevant' : notice.category}
                    </Text>
                  </Box>
                </HStack>
                <Text style={{ fontSize: 12, color: '#6B7280', lineHeight: 16 }}>
