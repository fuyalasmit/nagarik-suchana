...
const mockNotices = [
  {
    ...
    description:
      "Bharatpur Metropolitan City is seeking qualified candidates for Health Assistant positions. Candidates must have completed Health Assistant training from recognized institutions.",
  ...
  },
  {
    ...
    description:
      "Scheduled road maintenance work will be conducted on Main Road from January 10-15. Traffic will be diverted during working hours.",
  ...
  },
  {
    ...
    description:
      "Water supply will be temporarily disrupted for maintenance work on the main pipeline. Alternative arrangements have been made.",
  ...
  },
  {
    ...
    description:
      "Annual property tax collection has started. Citizens can pay online or visit the municipal office.",
  ...
  },
  {
    ...
    description:
      "Merit-based scholarship program for students from economically disadvantaged families.",
    category: "Education",
    deadline: "2026-02-28",
    location: "All Wards",
      ...
      <VStack style={{ marginBottom: 24 }} space="md">
        ...
        >
          ...
          >
            ...
            >
              {t("notices.relevantForMe")}
            </ButtonText>
          </Button>
          <Text style={{ fontSize: 12, color: "#6B7280" }}>
            {filteredNotices.length} {t("notices.title").toLowerCase()}
          </Text>
        </HStack>
                ...
                >
                  <Text
                    style={{
                      ...
                      fontWeight: "600",
                      color:
                        selectedCategory === category ? "white" : "#6B7280",
                    }}
                  >
                    {category}
                  </Text>
