    ...
    >
      ...
      >
        <VStack space="xl">
          ...
          <FormControl>
            <FormControlLabel>
              <FormControlLabelText style={{ fontWeight: '700', color: '#1F2937', fontSize: 16, marginBottom: 8 }}>
                Upload Document
              </FormControlLabelText>
            </FormControlLabel>
            ...
            {selectedFile ? (
              ...
              >
                <HStack style={{ justifyContent: 'space-between', alignItems: 'center' }}>
                  <Box style={{ flex: 1 }}>
                    <Text style={{ fontWeight: '700', color: '#1F2937', fontSize: 15, marginBottom: 4 }}>
                      {selectedFile.name}
                    </Text>
          ...
          <FormControl>
            <FormControlLabel>
              <FormControlLabelText style={{ fontWeight: '700', color: '#1F2937', fontSize: 16, marginBottom: 12 }}>
                Publication Status
              </FormControlLabelText>
            </FormControlLabel>
            <HStack space="md">
